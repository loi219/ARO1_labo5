...
\centering
    ...
    \label{fig:stamac}
\end{figure}
En rose, c'est l'instant où la première bascule (250,170) passe à $1$. On remarque qu'il s'agit de l'instant où le bit reçu en entrée \textbs{A} passe à $0$, alors qu'on a le COUNT\_4BITS qui vient de signaler 4 coups d'horloge.\\
Au-dessous, en bleu, la deuxième bascule (250,290) passe à $1$. On remarque qu'à ce moment, on a effectivement la première bascule déjà à $1$, et l'entrée \textbs{COUNT\_8BITS\_MAX} à $1$ aussi (ce qui annonce qu'on a reçu la séquence de 8 bits en entier).
